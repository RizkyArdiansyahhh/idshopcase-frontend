...
// app/(customer)/checkout/page.tsx  (atau pages/checkout.tsx)
"use client";
...
import { Input } from "@/components/ui/input"; // pastikan ada komponen input dari shadcn
import { UploadCard } from "@/features/checkout/components/UploadCard";
